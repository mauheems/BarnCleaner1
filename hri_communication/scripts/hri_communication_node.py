...
class HRICommunication:
    def __init__(self):
        ...
        self.nav_launch_file_path = self.base_path + 'src/group18/navigation/launch/navigation.launch'
        self.nav_launch_args = ['map_file:='+self.map_path+'.yaml']

        self.map_launch_file_path = self.base_path + 'src/group18/navigation/launch/mapping.launch'

        self.save_map_launch_file_path = '/home/mirte/mirte_ws//src/group18/navigation/launch/save_map.launch'
    ...
    def run(self):
        while not rospy.is_shutdown():
            ...
            if self.set_save_map_callback == 2:
                ...
                png_path = self.base_path + '/src/group18/interface_MDP/pictures/my_map.png'
                subprocess.call(['cp', pgm_path, self.base_path+'/src/group18/interface_MDP/pictures/my_map.pgm'])
